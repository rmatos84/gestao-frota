            ...
            <div style={{ background:"#0f172a", border:"1px solid #1e293b", borderRadius:16, overflow:"hidden" }}>
              {veiculos.length === 0 ? <div style={{ padding:40, textAlign:"center", color:"#475569" }}>Nenhum veículo cadastrado.</div>
                : veiculos.map((v,i) => <div key={v.id} style={{ padding:"14px 18px", borderTop:i>0?"1px solid #1e293b":"none", display:"flex", alignItems:"center", gap:12 }}>
                    ...
                    <button onClick={() => setEditingVeiculo(v)} style={{ background:"#2563eb", border:"none", color:"#fff", borderRadius:8, padding:"6px 10px", cursor:"pointer" }}>
                      Editar
                    </button>
                    <button onClick={() => deleteVeiculo(v.id)} style={{ background:"#dc2626", border:"none", color:"#fff", borderRadius:8, padding:"6px 10px", cursor:"pointer" }}>
                      Excluir
                    </button>
                  </div>)}
            </div>
            ...
            {editingVeiculo && (
              <div style={{ marginTop:16, background:"#0f172a", border:"1px solid #1e293b", borderRadius:16, padding:20 }}>
                ...
                <div style={{ display:"flex", gap:8, marginTop:12 }}>
                  <button onClick={updateVeiculo} style={{ background:"#10b981", border:"none", color:"#fff", borderRadius:8, padding:"8px 16px", cursor:"pointer" }}>
                    Salvar
                  </button>

                  <button onClick={() => setEditingVeiculo(null)} style={{ background:"#475569", border:"none", color:"#fff", borderRadius:8, padding:"8px 16px", cursor:"pointer" }}>
                    Cancelar
                  </button>
                </div>
              </div>
